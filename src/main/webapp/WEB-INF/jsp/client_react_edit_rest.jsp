...
<body>
	...
	<div class="header-text" >${messageclientreacteditrest}</div>
    
    <br>
    Edit a Persons by a ReactJS client and the Jersey Rest Web API
    <br><br>
   ...
   <script type="text/babel" src="react/editpersonreact.jsx" data-presets="es2015,react">
   </script>
