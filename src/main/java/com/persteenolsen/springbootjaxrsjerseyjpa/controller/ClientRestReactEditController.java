...
@Controller
public class ClientRestReactEditController {
	
	private String helloworld = "";
		
	//@GetMapping({"/", "/clientrest"})
	@GetMapping("/clientrestreactedit")
	public String clientrest(Map<String, Object> model) {

		helloworld = "Edit a Person by a ReactJS client / Jersey RESTful Web API";

		model.put("messageclientreacteditrest", helloworld);
				
		return "client_react_edit_rest";
	}
}